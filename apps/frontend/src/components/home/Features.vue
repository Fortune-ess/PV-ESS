...
const systemMonitoringIcon = ref(`
  <path
    stroke-linecap="round"
    stroke-linejoin="round"
    stroke-width="2"
...
const energyConsumptionIcon = ref(`
  <path
    stroke-linecap="round"
    stroke-linejoin="round"
    stroke-width="2"
