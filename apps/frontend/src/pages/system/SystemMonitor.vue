  ...
  <div class="flex flex-col min-h-screen w-full gap-2">
    <header class="shadow-md bg-white rounded-lg p-6">
      <div class="flex items-center justify-between">
        <h1 class="m-0 text-3xl font-bold text-gray-800">{{ $t('main.system.monitor.title') }}</h1>
        <div class="flex space-x-6">
          <button 
            @click="changeTab('meter')" 
            class="px-6 py-3 rounded-lg transition-all duration-300 shadow-sm"
            :class="activeTab === 'meter' ? 'bg-blue-200 text-gray-800 font-medium border border-gray-300' : 'bg-white hover:bg-blue-100 text-gray-800'"
          >
          ...
          <button 
            ...
            class="px-6 py-3 rounded-lg transition-all duration-300 shadow-sm"
            :class="activeTab === 'powerControl' ? 'bg-blue-200 text-gray-800 font-medium border border-gray-300' : 'bg-white hover:bg-blue-100 text-gray-800'"
          >
          ...
          <button 
            ...
            class="px-6 py-3 rounded-lg transition-all duration-300 shadow-sm"
            :class="activeTab === 'battery' ? 'bg-blue-200 text-gray-800 font-medium border border-gray-300' : 'bg-white hover:bg-blue-100 text-gray-800'"
          >
    ...
    <main class="flex-1 relative">
      <div class="w-full h-[calc(100vh-140px)] overflow-hidden rounded-lg shadow-md border border-gray-200">
