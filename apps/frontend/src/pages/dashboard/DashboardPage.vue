  ...
  <div class="flex flex-col 2xl:flex-row gap-2 sm:gap-3 md:gap-4 p-4">
    ...
    >
      <div class="flex flex-col gap-2 sm:gap-3 md:gap-4">
        <h1
          class="text-sm sm:text-base md:text-xl font-medium mb-2 sm:mb-3 md:mb-4 text-black flex items-center"
        >
          <span class="mr-2">{{
    ...
    >
      ...
      <div class="flex flex-col">
        <div
          class="h-40 sm:h-48 md:h-56 lg:h-64 relative bottom-0 mx-1 sm:mx-2 md:mx-3 my-1 sm:my-2"
        >
